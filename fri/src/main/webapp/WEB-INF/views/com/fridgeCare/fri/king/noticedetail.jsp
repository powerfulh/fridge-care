		...
		<!-- 중앙 작업 -->
			...
			<div class="w3-center">
				...
				<c:if test="${not empty ADMIN}">
					<form action="/fri/king/deletenotice.fri" id="deletenoticeform" class="inline">
						<input type="hidden" value="${JNVO.nno}" name="target">
						<a class="w3-teal w3-round-large w3-center w3-padding w3-button w3-hover-cyan change05bgc w3-margin-top" id="deletenoticebtn">삭제</a>
					</form>
				</c:if>
			</div>
		<!-- End Middle Column -->
